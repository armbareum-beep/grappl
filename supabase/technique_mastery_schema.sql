-- ============================================================================
-- Technique Mastery System Schema
-- Gamified skill progression with XP, levels, and combat stats integration
-- ============================================================================

-- Technique Master List (Pre-defined techniques by category)
CREATE TABLE IF NOT EXISTS techniques (
    ...
    -- Related content (optional pre-linking)
...
-- Technique XP Transactions (Audit log)
CREATE TABLE IF NOT EXISTS technique_xp_transactions (
    ...
    source_id UUID, -- ID of the related course/routine/log/post
...
-- Technique Relations (Many-to-Many linking)
...
-- User's monthly technique goals
...
-- Get XP required for each mastery level
CREATE OR REPLACE FUNCTION get_technique_xp_for_level(level INTEGER)
RETURNS INTEGER AS $$
BEGIN
    CASE level
        WHEN 1 THEN RETURN 0;      -- Lv1: Tried (0 XP)
        WHEN 2 THEN RETURN 100;    -- Lv2: Understood (100 XP)
        WHEN 3 THEN RETURN 300;    -- Lv3: Can Perform (300 XP)
        WHEN 4 THEN RETURN 600;    -- Lv4: Succeeds Occasionally (600 XP)
        WHEN 5 THEN RETURN 1000;   -- Lv5: High Success (1000 XP)
        WHEN 6 THEN RETURN 1500;   -- Lv6: Competition Ready (1500 XP)
        ELSE RETURN 0;
    END CASE;
END;
...
BEGIN
    ...
    -- Update combat stats (Arena integration)
    ...
    -- TODO: Update user's arena combat stats table
    -- This will be implemented when arena combat stats table is created
...
-- Everyone can view technique links
...
-- ============================================================================
-- Seed Data: Common BJJ Techniques
-- ============================================================================
