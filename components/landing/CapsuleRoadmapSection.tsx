            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col items-center">
                ...
                <div className="text-center max-w-4xl mx-auto mb-20">
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        className="text-4xl md:text-6xl font-black mb-6 leading-tight text-white tracking-tight"
                    >
                ...
                <div
                    ref={containerRef}
                    className="relative w-full max-w-4xl aspect-[16/9] md:aspect-[2/1] bg-zinc-900/30 backdrop-blur-sm border border-zinc-800/50 rounded-3xl p-8 shadow-2xl"
                >
