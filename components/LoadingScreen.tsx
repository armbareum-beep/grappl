    ...
    return (
        <div className="fixed inset-0 z-[999] flex flex-col items-center justify-center bg-[#09090b] overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center gap-8 p-6">
                {/* Advanced Spinner - Pure CSS */}
                <div className="relative w-24 h-24">
                    <div
                        className="absolute inset-0 rounded-full border-t-2 border-r-2 border-violet-500 shadow-[0_0_15px_rgba(139,92,246,0.5)] animate-spin"
                        style={{ animationDuration: '2s' }}
                    />
                    <div
                        className="absolute inset-4 rounded-full border-b-2 border-l-2 border-indigo-500 shadow-[0_0_15px_rgba(99,102,241,0.3)] animate-spin"
                ...
                <div className="text-center space-y-3">
                    <p className="text-white font-black text-lg tracking-tight animate-fade-in">
                        {message}
                    </p>
