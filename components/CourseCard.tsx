...
export const CourseCard: React.FC<CourseCardProps> = ({ course }) => {
    ...
    return (
        <Link to={`/courses/${course.id}`} className="group block h-full">
            <div className="bg-slate-900 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 h-full flex flex-col border border-slate-800 hover:border-blue-500/50">
                <div className="relative aspect-video overflow-hidden">
                    ...
                    {course.lessonCount && (
                        <div className="absolute bottom-2 right-2 bg-black/70 backdrop-blur-sm text-white text-xs px-2 py-1 rounded flex items-center">
