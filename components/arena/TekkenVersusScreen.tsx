    ...
    return (
        <div className="relative w-full h-[600px] bg-black overflow-hidden rounded-3xl border-4 border-slate-800 shadow-2xl group">
            ...
            <div className="absolute inset-0 flex flex-col md:flex-row">
                {/* Left Side (Player) */}
                <div className={`relative w-full h-1/2 md:w-1/2 md:h-full transition-all duration-1000 ${showVS ? '-translate-y-4 md:translate-y-0 md:-translate-x-4' : ''}`}>
                        ...
                        {!isSearching && !opponent ? (
                            <div className="text-center z-20">
                                ...
                                >
                                    ...
                                    <span className="relative z-10 text-xl md:text-3xl font-black text-white italic tracking-wider flex items-center gap-3">
            ...
            {showVS && (
                <div className="absolute inset-0 flex items-center justify-center z-30 pointer-events-none">
                    <div className="relative animate-vs-zoom">
                        ...
                        {/* VS Text */}
                        <h1 className="text-[80px] md:text-[150px] font-black italic leading-none text-transparent bg-clip-text bg-gradient-to-b from-yellow-300 via-yellow-500 to-orange-600 drop-shadow-[0_0_50px_rgba(234,179,8,0.8)] transform -skew-x-12"
