...
import { Play, ArrowRight, Clock, BarChart3 } from 'lucide-react';
...
export const DailyFreeDrillSection: React.FC = () => {
    ...
    const fetchDailyRoutines = async () => {
        // Fetch 3 random routines with extra info
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-violet-300/80 text-xl font-medium max-w-2xl mx-auto">
                        매일 3개의 프리미엄 루틴이 무료로 공개됩니다.
                    </p>
                </div>

                {/* 2. Daily Routine Cards */}
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20 px-4">
                    {routines.map((routine) => (
                        ...
                        >
                            {/* Left: Media Section (9:16 Aspect) */}
                            <div className="w-[120px] h-full relative overflow-hidden shrink-0">
                                <img
                            ...
                            <div className="flex-1 p-5 flex flex-col justify-between relative pl-6">
                                <div>
                                    <div className="flex items-center gap-2 mb-2">
                                        <div className="w-1 h-1 rounded-full bg-violet-500" />
                                        <span className="text-violet-400/80 text-[10px] font-black uppercase tracking-[0.2em]">Premium</span>
                                    </div>
                    ...
                    {routines.length === 0 && [1, 2, 3].map((_, i) => (
                        <div key={i} className="flex flex-row bg-zinc-900/40 border border-zinc-800/50 rounded-[32px] h-[240px] animate-pulse">
                            <div className="w-[120px] h-full bg-zinc-800/50" />
