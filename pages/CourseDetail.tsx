                        ...
                        <div className="bg-white border border-slate-200 rounded-xl shadow-lg p-6 sticky top-24">
                            ...
                            <div className="border-t border-slate-100 pt-6">
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <span className="text-xl font-bold text-blue-600">₩39,000<span className="text-sm text-slate-400 font-normal">/월</span></span>
                                </div>
                                {course.isSubscriptionExcluded ? (
                                    <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 mb-2 text-center">
                                        <p className="text-amber-800 font-bold text-sm">⛔ 구독 제외 상품</p>
                                        <p className="text-amber-600 text-xs mt-1">이 강좌는 단품 구매로만 시청 가능합니다.</p>
                                    </div>
                                ) : user?.isSubscriber ? (
                                    <Button className="w-full mb-2" disabled>
                                        ✓ 구독 중
