            ...
            <section className="py-24 bg-black border-b border-zinc-800 overflow-hidden relative">
                ...
                <div className="max-w-7xl mx-auto px-4 relative z-10">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-16" id="arena-cards">
                        ...
                        {/* Card 3: 테크닉로드맵 */}
                        <div className="group relative bg-zinc-900/30 rounded-3xl p-8 border border-zinc-800 hover:border-emerald-500/40 hover:bg-zinc-900/50 transition-all duration-500 hover:-translate-y-1">
                            <div className="absolute top-4 right-6 text-[80px] font-black text-white/[0.02] group-hover:text-emerald-500/[0.05] transition-colors leading-none select-none -z-10">
                                03
                            </div>

                            <div className="w-12 h-12 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mb-6 text-emerald-500 group-hover:scale-110 group-hover:bg-emerald-500 group-hover:text-black transition-all duration-300 shadow-[0_0_20px_-5px_rgba(16,185,129,0.2)]">
                            ...
                            <ul className="space-y-3">
                                {[
                                    ...
                                    <li key={i} className="flex items-center gap-3 text-sm text-zinc-500 group-hover:text-zinc-300 transition-colors">
                                        <div className="w-1.5 h-1.5 rounded-full bg-emerald-500/40 group-hover:bg-emerald-400"></div>
                                        {item}
                                    </li>
                                ))}
                            </ul>
