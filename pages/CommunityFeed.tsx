...
export const CommunityFeed: React.FC = () => {
    ...
    const filteredPosts = posts.filter(post => {
        ...
        if (filter === 'skill_roadmap') {
            return post.type === 'technique_chain';
        }
    ...
    return (
        <div className="min-h-screen bg-zinc-950 text-zinc-200" onClick={() => setShowFilterMenu(false)}>
            ...
            <main className="mx-auto pt-[30px] pb-32 max-w-xl px-4 transition-all">
                <>
