                    ...
                    <div className="space-y-6 text-slate-300">
                        ...
                        <section>
                            ...
                            <ul className="list-disc list-inside space-y-2 ml-4">
                                <li>"서비스"란 회사가 제공하는 온라인 주짓수 교육 콘텐츠 및 관련 서비스를 의미합니다.</li>
                                <li>"회원"이란 본 약관에 동의하고 회사와 서비스 이용계약을 체결한 자를 말합니다.</li>
                                <li>"콘텐츠"란 회사가 제공하는 강좌, 영상, 루틴, 드릴 등 모든 교육 자료를 의미합니다.</li>
                                <li>"크리에이터"란 회사의 플랫폼을 통해 콘텐츠를 제작하고 판매하는 자를 말합니다.</li>
                            </ul>
                        </section>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-white mb-4">제4조 (회원가입)</h2>
                            <ol className="list-decimal list-inside space-y-2 ml-4">
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-white mb-4">제5조 (서비스의 제공)</h2>
                            <ol className="list-decimal list-inside space-y-2 ml-4">
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-white mb-4">제6조 (유료 서비스 및 결제)</h2>
                            <ol className="list-decimal list-inside space-y-2 ml-4">
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-white mb-4">제7조 (저작권 및 지적재산권)</h2>
                            <ol className="list-decimal list-inside space-y-2 ml-4">
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-white mb-4">제8조 (회원의 의무)</h2>
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-white mb-4">제9조 (서비스 이용 제한)</h2>
                            <p className="leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-white mb-4">제10조 (면책조항)</h2>
                            <ol className="list-decimal list-inside space-y-2 ml-4">
